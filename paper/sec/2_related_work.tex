...
windows, maintenance, and
lighting~\cite{li2015greenery,denadai2016lively,jiang2018brokenwindows,portnov2020lighting}.
However, none provides scene-level tests of localised, validity-audited
...
explanations in urban analytics.
UrbanPhysicalDisorder-4K~\cite{vera2025} brings counterfactual reasoning
...
scene. This reframes the edit as a testable hypothesis rather than a
product, and each result is retained only after explicit validity
...
drift, which our critic must catch. Mask-constrained generation (e.g.\
inpainting within a detected support region) is a natural next step that
would tighten spatial control while preserving the attribution
framework.
