...
\textbf{(i)}~\emph{theoretical grounding} in the urban perception
...
\subsection{Phase 3: Model-based Evaluation}
...
This is strictly a model-based evaluation, not the main estimand; $f_a$ has
not been tuned on edited images, so $\Delta_i$ should be treated as
a ranking signal. The proxy-shortlisted set is
\begin{equation}
...
pixel-level attribution or causal identification. ``Multiple levers''
