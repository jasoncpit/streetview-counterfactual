...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/figure_3_qualitative.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/figure_5_delta_cutoff_counts.png}
  ...
  $\theta_{\mathrm{aux}}{=}0.1$ proxy-shortlisted levers per scene
  with 95\,\% CI.}
...
\begin{figure}[H]
  ...
  \caption{Baseline safety score vs.\ valid lever count per scene
  ($N{=}50$). No meaningful relationship is observed
...
% ── A.2  Validity and Coverage Details ──────────────────────────────
